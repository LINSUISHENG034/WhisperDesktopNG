/*
 * CWhisperEngineNew.h - Modern C++ wrapper for latest whisper.cpp interface
...
class CWhisperEngineNew {
public:
    // Constructor: load model with configuration, throw exception on failure
    explicit CWhisperEngineNew(const std::string& modelPath, 
    ...
    CWhisperEngineNew(const CWhisperEngineNew&) = delete;
    CWhisperEngineNew& operator=(const CWhisperEngineNew&) = delete;

    // Enable move semantics for efficient resource transfer
    CWhisperEngineNew(CWhisperEngineNew&& other) noexcept;
    CWhisperEngineNew& operator=(CWhisperEngineNew&& other) noexcept;
